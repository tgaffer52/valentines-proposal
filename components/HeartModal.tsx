...
export const HeartModal: React.FC<HeartModalProps> = ({
  isOpen,
  onClose,
  message = "Yay! Happy Valentine's Day! ❤️",
}) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-300">
      <div className="bg-white rounded-3xl p-8 max-w-sm w-full text-center shadow-2xl transform transition-all scale-100 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-10">
          <div className="absolute top-10 left-10 text-4xl text-pink-500">
            ❤️
          </div>
          <div className="absolute bottom-10 right-10 text-4xl text-red-500">
            💖
          </div>
          <div className="absolute top-1/2 left-1/4 text-2xl text-pink-300">
            💕
          </div>
        </div>
